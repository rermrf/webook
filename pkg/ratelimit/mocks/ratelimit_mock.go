...
// Source: bff/pkg/ratelimit/validator.go
//
// Generated by this command:
//
//	mockgen -source=bff/pkg/ratelimit/validator.go -package=limitmocks -destination=bff/pkg/ratelimit/mocks/ratelimit_mock.go
//
