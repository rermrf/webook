...
const file_cronjob_v1_cronjob_proto_rawDesc = "" +
	"\n" +
	"\x18cronjob/v1/cronjob.proto\x12\n" +
	"cronjob.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa8\x01\n" +
	"\aCronJob\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04cron\x18\x03 \x01(\tR\x04cron\x12\x1a\n" +
	"\bexecutor\x18\x04 \x01(\tR\bexecutor\x12\x10\n" +
	"\x03cfg\x18\x05 \x01(\tR\x03cfg\x127\n" +
	"\tnext_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\bnextTime\"\x10\n" +
	"\x0ePreemptRequest\"8\n" +
	"\x0fPreemptResponse\x12%\n" +
	"\x03job\x18\x01 \x01(\v2\x13.cronjob.v1.CronJobR\x03job\"=\n" +
	...
	"\x0eAddJobResponse2\xeb\x01\n" +
	"\x0eCronJobService\x12B\n" +
	"\aPreempt\x12\x1a.cronjob.v1.PreemptRequest\x1a\x1b.cronjob.v1.PreemptResponse\x12T\n" +
	"\rResetNextTime\x12 .cronjob.v1.ResetNextTimeRequest\x1a!.cronjob.v1.ResetNextTimeResponse\x12?\n" +
	"\x06AddJob\x12\x19.cronjob.v1.AddJobRequest\x1a\x1a.cronjob.v1.AddJobResponseB\x92\x01\n" +
	"\x0ecom.cronjob.v1B\fCronjobProtoP\x01Z)webook/api/proto/gen/cronjob/v1;cronjobv1\xa2\x02\x03CXX\xaa\x02\n" +
	"Cronjob.V1\xca\x02\n" +
