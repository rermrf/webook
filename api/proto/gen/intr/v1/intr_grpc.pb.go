...
const (
	...
	InteractiveService_ListUserLiked_FullMethodName     = "/intr.v1.InteractiveService/ListUserLiked"
	InteractiveService_ListUserCollected_FullMethodName = "/intr.v1.InteractiveService/ListUserCollected"
)
...
type InteractiveServiceClient interface {
	...
	ListUserLiked(ctx context.Context, in *ListUserLikedRequest, opts ...grpc.CallOption) (*ListUserLikedResponse, error)
	ListUserCollected(ctx context.Context, in *ListUserCollectedRequest, opts ...grpc.CallOption) (*ListUserCollectedResponse, error)
}
...
func (c *interactiveServiceClient) ListUserLiked(ctx context.Context, in *ListUserLikedRequest, opts ...grpc.CallOption) (*ListUserLikedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUserLikedResponse)
	err := c.cc.Invoke(ctx, InteractiveService_ListUserLiked_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *interactiveServiceClient) ListUserCollected(ctx context.Context, in *ListUserCollectedRequest, opts ...grpc.CallOption) (*ListUserCollectedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUserCollectedResponse)
	err := c.cc.Invoke(ctx, InteractiveService_ListUserCollected_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InteractiveServiceServer interface {
	...
	ListUserLiked(context.Context, *ListUserLikedRequest) (*ListUserLikedResponse, error)
	ListUserCollected(context.Context, *ListUserCollectedRequest) (*ListUserCollectedResponse, error)
...
func (UnimplementedInteractiveServiceServer) ListUserLiked(context.Context, *ListUserLikedRequest) (*ListUserLikedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListUserLiked not implemented")
}
func (UnimplementedInteractiveServiceServer) ListUserCollected(context.Context, *ListUserCollectedRequest) (*ListUserCollectedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListUserCollected not implemented")
}
...
func _InteractiveService_ListUserLiked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListUserLikedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).ListUserLiked(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_ListUserLiked_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).ListUserLiked(ctx, req.(*ListUserLikedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InteractiveService_ListUserCollected_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListUserCollectedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).ListUserCollected(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_ListUserCollected_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).ListUserCollected(ctx, req.(*ListUserCollectedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InteractiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListUserLiked",
			Handler:    _InteractiveService_ListUserLiked_Handler,
		},
		{
			MethodName: "ListUserCollected",
			Handler:    _InteractiveService_ListUserCollected_Handler,
		},
	},
