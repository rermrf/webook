...
//
//	mockgen -source=./user.go -package=repomocks -destination=mocks/user_mock.go
//
...
// UpdateNoSensitiveById mocks base method.
func (m *MockUserRepository) UpdateNoSensitiveById(ctx context.Context, u domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNoSensitiveById", ctx, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateNoSensitiveById indicates an expected call of UpdateNoSensitiveById.
func (mr *MockUserRepositoryMockRecorder) UpdateNoSensitiveById(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNoSensitiveById", reflect.TypeOf((*MockUserRepository)(nil).UpdateNoSensitiveById), ctx, u)
}
