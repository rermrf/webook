...
//
//	mockgen -source=./user.go -package=svcmocks -destination=mocks/user_mock.go
//
...
func (m *MockUserService) EditNoSensitive(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EditNoSensitive", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// EditNoSensitive indicates an expected call of EditNoSensitive.
func (mr *MockUserServiceMockRecorder) EditNoSensitive(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditNoSensitive", reflect.TypeOf((*MockUserService)(nil).EditNoSensitive), ctx, user)
}
