...
func InitGin(mdls []gin.HandlerFunc, hdl *handler.UserHandler, oauth2WechatHdl *handler.OAuth2WechatHandler, articleHdl *handler.ArticleHandler, followHdl *handler.FollowHandler, searchHdl *handler.SearchHandler, notificationHdl *handler.NotificationHandler, creditHdl *handler.CreditHandler, tagHdl *handler.TagHandler, feedHdl *handler.FeedHandler, rankingHdl *handler.RankingHandler, imHdl *handler.IMHandler, historyHdl *handler.HistoryHandler, uploadHdl *handler.UploadHandler) *gin.Engine {
	server := gin.Default()
	server.Use(mdls...)
