...
func InitApp() *App {
	...
	engine := ioc.InitGin(v, userHandler, oAuth2WechatHandler, articleHandler, followHandler, searchHandler, notificationHandler, creditHandler, tagHandler, feedHandler, rankingHandler, imHandler, historyHandler, uploadHandler)
