...
//
//	mockgen -source=./article.go -package=repomocks -destination=mocks/article_mock.go ArticleRepository
//
...
func (m *MockArticleRepository) ListPub(ctx context.Context, startTime time.Time, offset, limit int) ([]domain.Article, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleRepositoryMockRecorder) ListPub(ctx, startTime, offset, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPub", reflect.TypeOf((*MockArticleRepository)(nil).ListPub), ctx, startTime, offset, limit)
}
